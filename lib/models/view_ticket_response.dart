...
ViewTicketResponse viewTicketResponseFromJson(String str) => ViewTicketResponse.fromJson(json.decode(str));

String viewTicketResponseToJson(ViewTicketResponse data) => json.encode(data.toJson());

class ViewTicketResponse {
  List<ViewTicketResult> result;

  ViewTicketResponse({
    required this.result,
  });

  factory ViewTicketResponse.fromJson(Map<String, dynamic> json) => ViewTicketResponse(
    result: List<ViewTicketResult>.from(json["result"].map((x) => ViewTicketResult.fromJson(x))),
  );
...
class ViewTicketResult {
  ...
  factory ViewTicketResult.fromJson(Map<String, dynamic> json) => ViewTicketResult(

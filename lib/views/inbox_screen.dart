...
import '../models/serach_result.dart' as search_model;
...
class InboxScreen extends StatefulWidget {
  ...
  const InboxScreen({super.key, this.refreshNotifier});
...
class _InboxScreenState extends State<InboxScreen> {
  ...
  Future<void> _loadTickets() async {
    try {
      ...
      final ticketResponse = await _ticketService.getInboxTickets();
      setState(() {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        drawer: SideMenuWidget(
          onScreenChange: (Widget screen, String title) {
          ...
          viewItems: const [],
          viewExpansionNotifier: ValueNotifier({}),
          onViewExpansionToggle: (int viewId) {},
        ),
                    ...
                    ? _isSearching
                          ...
                          ? ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return _buildSearchResultItem(context, ticket);
                              },
                            )
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => TicketDetailsScreen(
              ...
              fromTrash: false,
              onTicketTrashed: () {
                // Refresh the inbox list when ticket is moved to trash
                _loadTickets();
              },
            ),
          ),
